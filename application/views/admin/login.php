            ...
            <div class="row">
                ...
                <div class="col-lg-6 bg-white">
                    <div class="form d-flex align-items-center">
                        <div class="content">
                            <form id="login-form" method="post" action="<?=base_url()?>admin/login/be_login">
...
<!--################################flash data şekilli şukullu yaz#####################################-->
                                    <?=$this->session->flashdata("msj");?>
                                </div><input type="submit" class="btn btn-primary" value="Giriş"></a>
