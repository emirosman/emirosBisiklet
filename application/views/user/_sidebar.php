<div class="page-content d-flex align-items-stretch">
    ...
    <nav class="side-navbar">
        ...
        <ul class="list-unstyled">
            ...
            <li> <a href="<?=base_url()?>"><i class="icon-user"></i>Kullanıcılar</a></li>
            <li> <a href="index.html"><i class="fa fa-book"></i>Kategoriler</a></li>
            <li> <a href="index.html"><i class="fa fa-bicycle"></i>Ürünler</a></li>
